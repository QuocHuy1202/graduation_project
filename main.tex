...
\begin{table}[h]
\begin{tabular}{rll}
\hspace{6 cm} &  \textbf{\large HỘI ĐỒNG:} {\large Khoa học máy tính 23}
\\
\\
...
\\
\\
\hspace{6 cm} &   \textbf{\large GVPB:} {\large TS. Trần Tuấn Anh}
...
\vspace{0.5cm}
\begin{center}
{\large TP. HỒ CHÍ MINH, 6/2026 }
\end{center}
\end{titlepage}
%\thispagestyle{empty}
\newpage

% \includepdf[pages=-]{phieu_nhiem_vu.pdf}
\newpage
%%%%%%%%%%%%%%%%%INTRO%%%%%%%%%%%%%%%%%%%
...
\newpage
\input{Contents/PhuongPhapDeXuat}
\newpage
\input{Contents/ThucNghiemVaDanhGia}
\newpage
\input{Contents/HuongPhatTrien}
%%%%%%%%%%%%%%%%%OUTRO%%%%%%%%%%%%%%%%%%%
