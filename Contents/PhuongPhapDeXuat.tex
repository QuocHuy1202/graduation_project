...
\section{Tinh chỉnh và Sinh lời giải thích với LLM}

Trong các hệ thống gợi ý truyền thống, kết quả từ các mô hình học sâu (Bi-Encoder, Cross-Encoder) thường là những điểm số định lượng mang tính "hộp đen". Để giải quyết bài toán diễn giải và tăng độ tin cậy, hệ thống tích hợp Mô hình Ngôn ngữ Lớn vào giai đoạn cuối của đường ống dữ liệu với hai vai trò cốt lõi:

\begin{description}
    \item[Bộ sinh lời giải thích:] \hfill \\
    Đối với các sản phẩm được chọn, LLM chịu trách nhiệm sinh ra các văn bản tự nhiên để giải thích lý do gợi ý. Việc minh bạch hóa quyết định (ví dụ: liên kết trực tiếp giữa tính năng của sản phẩm mới với sở thích trong lịch sử mua hàng) giúp nâng cao trải nghiệm cá nhân hóa và thuyết phục người dùng.

    \item[Bộ lọc cuối cùng:] \hfill \\
    Thay vì chỉ dựa trên điểm số toán học, LLM nhận đầu vào là danh sách Top-K sản phẩm đã được lọc qua Cross-Encoder, kết hợp cùng truy vấn và toàn bộ lịch sử mua hàng. Khả năng hiểu ngữ cảnh sâu sắc giúp LLM đánh giá toàn diện sự phù hợp, từ đó đóng vai trò như một "giám khảo" tự động chọn ra 1 đến 3 sản phẩm tối ưu nhất, loại bỏ các kết quả nhiễu mà mô hình nhúng có thể chấm điểm sai.
\end{description}
