\begin{table}[h!]
    ...
    \begin{itemize}[leftmargin=*, nosep]
        \item Nghiên cứu và tích hợp mô hình ngôn ngữ lớn (LLM) để sinh văn bản giải thích lý do gợi ý.
    ...
    \end{itemize}
    \textbf{2. Nghiên cứu Cross-Encoder:}
    \begin{itemize}[leftmargin=*, nosep]
        \item Tìm hiểu cơ sở lý thuyết và kiến trúc của mô hình Cross-Encoder cho bài toán Re-ranking.
        \item Đề xuất giải pháp và kiến trúc tích hợp Cross-Encoder để cải thiện độ chính xác (định hướng phát triển tương lai).
    \end{itemize}
    \\ \midrule
    ...
    & 
    \textbf{Xây dựng Tháp Người dùng (User Tower):}
    \begin{itemize}[leftmargin=*, nosep, after=\vspace{0.3em}]
