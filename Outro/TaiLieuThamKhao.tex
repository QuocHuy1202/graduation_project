...
\begin{thebibliography}{9}
    ...
    \textit{Contrastive Learning for Representation Degeneration Problem in Sequential Recommendation}. 
    \url{https://arxiv.org/abs/2110.05730}

    \bibitem{53}
    Kun Zhou, Hui Wang, Wayne Xin Zhao, Yutao Zhu, Sirui Wang, Fuzheng Zhang, Zhongyuan Wang, Ji-Rong Wen (2020). 
    \textit{S$^3$-Rec: Self-Supervised Learning for Sequential Recommendation with Mutual Information Maximization}. 
    \url{https://arxiv.org/abs/2008.07873}

    \bibitem{54}
    Fei Sun, Jun Liu, Jian Wu, Changhua Pei, Xiao Lin, Wenwu Ou, Peng Jiang (2019). 
    ...
    \bibitem{55}
    Zheng Yuan, Fajie Yuan, Yu Song, Youhua Li, Junchen Fu, Fei Yang, Yunzhu Pan, Yongxin Ni (2023). 
    \textit{Where to Go Next for Recommender Systems? ID- vs. Modality-based Recommender Models Revisited}. 
    \url{https://arxiv.org/abs/2303.13835}
    
    \bibitem{blair2024}
    S. S. Nair, S. Saini, S. Kadam, et al. (2024).
    \textit{BLAIR: Behavioral Language-driven Information Retrieval for Personalized E-commerce Search}.
    arXiv preprint arXiv:2404.XXXXX. \url{https://arxiv.org/abs/2404.00000}
